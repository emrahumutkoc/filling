...
public class HeatMapVisual : MonoBehaviour {
    ...
    private GridSpriteSystem<bool> grid;
    private Mesh mesh;
    ...
    public void SetGrid(GridSpriteSystem<bool> grid) {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridValueChanged(object sender, GridSpriteSystem<bool>.OnGridValueChangedEventArgs e) {
        //UpdateHeatMapVisual();
        updateMesh = true;
    }
